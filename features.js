...
const headingBlocks = document.querySelectorAll(".scroll-heading");
...
headingBlocks.forEach((item) => headingObserver.observe(item));
...
style.textContent = `
  .hero-title .word-rise {
    ...
    margin-right: 0.24em;
    opacity: 0;
    transform: translateY(24px) rotateX(28deg);
    animation: wordRise 0.85s ease forwards;
  }
